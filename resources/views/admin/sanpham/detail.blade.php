        ...
        <form class="form-horizontal " action="{{ route('route_BackEnd_Sanpham_update', ['id' => request()->route('id')]) }}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div style="padding-right: 130px;" class="col-md-9">
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-8">
                        <div class="row">
                            <div class="col-xs-6">
                                <img id="mat_truoc_preview"
                                     src="{{ Storage::url($objitem_sp->hinh_anh)}}"
                ...
                <div class="form-group">
                    ...
                    <input style=" height:50px" type="text" name="mo_ta" id="" class="form-control"
                        value="{{ $objitem_sp->mo_ta }}">
                    <span id="mes_sdt"></span>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="id_danhmuc" id="" class="form-control" required="required">
                        <option value=" {{-- {{DB::table('danh_muc')->where('id','=',$objitem_sp->id_danhmuc)->first()->ten_danhmuc}} --}}">Chọn</option> 
                        @foreach ($dm as $d)
                            <option {{ $d->id == $objitem_sp->id_danhmuc?'selected':''}}  value="{{ $d->id }}">{{ $d->ten_danhmuc }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="so_luong" id="" class="form-control"
                        value="{{ $objitem_sp->so_luong }}">
                    <span id="mes_sdt"></span>
                </div>
                <div class="form-group">
                    <label for="">Giá</label>
                    {{-- <input type="text" class="form-control" name="gia" id="" placeholder=""> --}}
                    <input type="number" name="gia" id="" class="form-control" value="{{ $objitem_sp->gia }}">
                    <span id="mes_sdt"></span>
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="radio">
                        <label for="">
                            <input  {{ 1 == $objitem_sp->trang_thai?'checked':''}}   type="radio" name="trang_thai" id="input" value="1"
                                > Còn Hàng
                        </label>
                    </div>
                    <div class="radio">
                        <label for="">
                            <input type="radio"   {{ 0 == $objitem_sp->trang_thai?'checked':''}}   name="trang_thai" id="" value="0">
                            Hết hàng
                        </label>
                    </div>
